...
typedef struct ModifyTableState
{
	...
	Bitmapset	*mt_leaf_relids_inserted_lo;
	Bitmapset	*mt_leaf_relids_inserted_hi;
	Bitmapset	*mt_leaf_relids_updated_lo;
	Bitmapset	*mt_leaf_relids_updated_hi;
	Bitmapset	*mt_leaf_relids_deleted_lo;
	Bitmapset	*mt_leaf_relids_deleted_hi;
} ModifyTableState;
